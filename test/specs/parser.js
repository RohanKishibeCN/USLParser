...
describe('Parser', function() {
  ...
  describe('Basic Information', function() {
    it('should fail unsupported yaml version', function(done) {
      ...
      usl.load(definition).should.be.rejectedWith(/found incompatible YAML document \(version 1.2 is required\)/).and.notify(done);
    });
    ...
    usl.load(definition).should.be.rejectedWith(/missing title/).and.notify(done);
    });
    it('should fail if title is array', function(done) {
        ...
        usl.load(definition).should.be.rejectedWith(/title must be a string/).and.notify(done);
    });
    describe('feature flags', function (){
        it('should not validate title if flag is set not to validate', function(done) {
            ...
            usl.load(definition, 'filename.yml', {validate: false, transform: false, compose: true}).should.be.fulfilled.and.notify(done);
        });
        it('should not validate title if flag is set not to validate', function(done) {
            var definition = [
                '#%USL 0.1',
            ...
            usl.load(definition, 'filename.yml', {validate: false, transform: true, compose: true}).should.be.fulfilled.and.notify(done);
        });
        it('should not apply transformations if flag is set to ignore', function(done) {
            ...
            usl.load(definition, 'filename.yml',  {validate: false, transform: false, compose: true}).should.become(expected).and.notify(done);
        });
        it('should not apply transformations if flag is set to ignore', function(done) {
            var definition = [
                '#%USL 0.1',
            ...
            usl.load(definition, 'filename.yml',  {validate: true, transform: false, compose: true}).should.become(expected).and.notify(done);
        });
        it('should apply transformations if flag is set to ignore', function(done) {
            ...
            usl.load(definition, 'filename.yml',  {validate: true, transform: true, compose: true}).should.become(expected).and.notify(done);
        });
        it('should apply transformations if flag is set to ignore', function(done) {
            var definition = [
                '#%USL 0.1',
            ...
            usl.load(definition, 'filename.yml',  {validate: true, transform: true}).should.become(expected).and.notify(done);
        });
    ...
    it('should allow number title', function(done) {
      ...
      usl.load(definition).should.become({ title: 54, baseUri: 'http://myapi.com', protocols: ['HTTP'] }).and.notify(done);
    });
    ...
    it('should fail if there is a root property with wrong displayName', function(done) {
      ...
      usl.load(definition).should.be.rejectedWith(/unknown property/).and.notify(done);
    });
    ...
    it('should fail if there is a root property with array', function(done) {
      ...
      usl.load(definition).should.be.rejectedWith(/only scalar map keys are allowed in USL/).and.notify(done);
    });
  });
  ...
  describe('Include', function() {
    it('should fail if include not found', function(done) {
      ...
      usl.load(definition).should.be.rejectedWith(/cannot (read|fetch) relative\.md/).and.notify(done);
    });
    ...
    it('should succeed on including another YAML file with .yml extension', function(done) {
      ...
      usl.load(definition).should.eventually.deep.equal({ title: 'MyApi', documentation: [ { title: 'Getting Started', content: '# Getting Started\n\nThis is a getting started guide.' } ] }).and.notify(done);
    });
    ...
    it('should succeed on including another YAML file with .yaml extension', function(done) {
      var definition = [
        '#%USL 0.1',
        '---',
        '!include http://localhost:9001/test/usl-files/external.yaml'
      ].join('\n');
    ...
    it('should succeed on including another YAML file mid-document', function(done) {
      var definition = [
        ...
        'title: Test',
        'traits:',
        '   - customTrait1: !include http://localhost:9001/test/usl-files/customtrait.yml',
        '   - customTrait2: !include http://localhost:9001/test/usl-files/customtrait.yml'
      ].join('\n');

        usl.load(definition).should.eventually.deep.equal({
          title: 'Test',
          traits:
            [
            {
  ...
  describe('URI Parameters', function() {
    ...
    it('should fail when a parameter uses array syntax with only one type', function(done) {
      ...
      usl.load(definition).should.be.rejectedWith(/single type for variably typed parameter/).and.notify(done);
    });
    ...
    it('should fail when declaring a property inside a URI parameter that is not valid', function(done) {
      ...
      usl.load(definition).should.be.rejectedWith(/unknown property wrongPropertyName/).and.notify(done);
    });
    ...
    it('should fail when declaring an enum with duplicated values', function(done) {
      ...
      usl.load(definition).should.be.rejectedWith(/enum contains duplicated values/).and.notify(done);
    });
    ...
    it('should fail when declaring an enum with no values', function(done) {
      ...
      usl.load(definition).should.be.rejectedWith(/enum is empty/).and.notify(done);
    });
    ...
    it('should fail when declaring an enum with map value', function(done) {
      ...
      usl.load(definition).should.be.rejectedWith(/the value of enum must be an array/).and.notify(done);
    });
    ...
    it('should fail when declaring a minLength validation as anything other than a number', function(done) {
      ...
      usl.load(definition).should.be.rejectedWith(/the value of minLength must be a number/).and.notify(done);
    });
    ...
    it('should fail when declaring a maxLength validation as anything other than a number', function(done) {
      ...
      usl.load(definition).should.be.rejectedWith(/the value of maxLength must be a number/).and.notify(done);
    });
    ...
    it('should fail when declaring a minimum validation as anything other than a number', function(done) {
      ...
      usl.load(definition).should.be.rejectedWith(/the value of minimum must be a number/).and.notify(done);
    });
    ...
    it('should fail when declaring a maximum validation as anything other than a number', function(done) {
      ...
      usl.load(definition).should.be.rejectedWith(/the value of maximum must be a number/).and.notify(done);
    });
    ...
    it('should fail when declaring a URI parameter with an invalid type', function(done) {
      ...
      usl.load(definition).should.be.rejectedWith(/type can be either of: string, number, integer, file, date or boolean/).and.notify(done);
    });
    ...
    it('should fail if baseUri value its not really a URI', function(done) {
      ...
      usl.load(definition).should.be.rejectedWith(/unclosed brace/).and.notify(done);
    });
    ...
    it('should fail if baseUri uses version but there is no version defined', function(done) {
      ...
      usl.load(definition).should.be.rejectedWith(/missing version/).and.notify(done);
    });
    ...
    it('should succeed if baseUri uses version and there is a version defined', function(done) {
      ...
      var promise = usl.load(definition);
      var expected = {
        title: 'MyApi',
        version: 'v1',
        baseUri: 'http://myapi.com/{version}',
  ...
  describe('MultiType Named Parameters', function() {
    describe('Named parameters in baseUriParameters at root level', function(){
      ...
      it('should fail when a parameter uses array syntax with no types', function(done) {
        ...
        usl.load(definition).should.be.rejectedWith(/named parameter needs at least one type/).and.notify(done);
      });
  ...
  describe('Resources', function() {
    it('should fail on duplicate absolute URIs', function(done) {
      ...
      usl.load(definition).should.be.rejectedWith(/two resources share same URI \/a\/b/).and.notify(done);
    });
    ...
    it('is should fail when resource is a scalar', function(done) {
      ...
      usl.load(definition).should.be.rejectedWith(/resource is not a map/).and.notify(done);
    });
  ...
  describe('Resource Responses', function() {
    ...
    it('should fail if status code is string', function(done) {
      ...
      usl.load(definition).should.be.rejectedWith(/each response key must be an integer/).and.notify(done);
    });
  ...
  describe('Traits at resource level', function() {
    it('should succeed when applying traits across !include boundaries', function(done) {
      var definition = [
          ...
          'title: Test',
          'traits:',
          '  - customTrait: !include http://localhost:9001/test/usl-files/customtrait.yml',
          '/: !include http://localhost:9001/test/usl-files/root.yml'
      ].join('\n');
    ...
    it('should fail if use property is not an array', function(done) {
      ...
      usl.load(definition).should.be.rejectedWith(/property 'is' must be an array/).and.notify(done);
    });
    ...
    it('should fail on invalid trait name', function(done) {
      ...
      usl.load(definition).should.be.rejectedWith('there is no trait named throttled').and.notify(done);
    });
    ...
    it('should reject parameters whose value is an array', function(done) {
      ...
      usl.load(definition).should.be.rejectedWith(/parameter value must be a scalar/).and.notify(done);
    });
    ...
    it('should reject trait with missing provided parameters', function(done) {
      ...
      usl.load(definition).should.be.rejectedWith(/value was not provided for parameter: lalalalala/).and.notify(done);
    });
  ...
  describe('Traits at method level', function() {
    it('should succeed when applying traits across !include boundaries', function(done) {
      var definition = [
        ...
        'traits:',
        '  - customTrait: !include http://localhost:9001/test/usl-files/customtrait.yml',
        '/: !include http://localhost:9001/test/usl-files/traitsAtResourceLevel.yml'
      ].join('\n');
  ...
  describe('Resource Types', function () {
    ...
    it('should fail if resourceTypes value is scalar', function(done) {
      ...
      usl.load(definition).should.be.rejectedWith(/invalid resourceTypes definition, it must be an array/).and.notify(done);
    });
    ...
    it('should fail if type is an array', function(done) {
      ...
      usl.load(definition).should.be.rejectedWith(/property 'type' must be a string or a map/).and.notify(done);
    });
    ...
    it('should fail if resource is of a missing type', function(done) {
      ...
      usl.load(definition).should.be.rejectedWith(/there is no resource type named invalidType/).and.notify(done);
    });
    ...
    it('should fail if resource type is null', function(done) {
      ...
      usl.load(definition).should.be.rejectedWith(/invalid resourceType definition, it must be a map/).and.notify(done);
    });
    ...
    it('should fail if type dictionary has no keys', function(done) {
      ...
      usl.load(definition).should.be.rejectedWith('resource type name must be provided').and.notify(done);
    });
    ...
    it('should fail if a resource type inherits from a missing type', function(done) {
      ...
      usl.load(definition).should.be.rejectedWith(/there is no resource type named missing/).and.notify(done);
    });
    ...
    it('should fail if a resource type applies a missing trait', function(done) {
      ...
      usl.load(definition).should.be.rejectedWith('there is no trait named bar').and.notify(done);
    });
    ...
    it.skip('should fail if names collide', function(done) {
      ...
      usl.load(definition).should.be.rejectedWith(/Resource type with the same name already exists/).and.notify(done);
    });
    ...
    it('should fail if type property has more than one key', function(done) {
      ...
      usl.load(definition).should.be.rejectedWith(/a resource or resourceType can inherit from a single resourceType/).and.notify(done);
    });
    ...
    it('should fail if parameters are missing', function(done) {
      ...
      usl.load(definition).should.be.rejectedWith(/value was not provided for parameter: bar/).and.notify(done);
    });
    ...
    it('should fail if resourceType uses a missing trait', function(done) {
      ...
      usl.load(definition).should.be.rejectedWith('there is no trait named blah').and.notify(done);
    });
    ...
    describe('- Unknown methods', function(){
      describe('- In resources', function(){
        it('should fail if calling an unknown method in a property', function(done){
          ...
          usl.load(definition).should.be.rejectedWith(/unknown function applied to property name/).and.notify(done);
        });
        ...
        it('should fail if calling an unknown method in a value in an applied type', function(done){
          ...
          usl.load(definition).should.be.rejectedWith(/unknown function applied to parameter/).and.notify(done);
        });
  ...
  describe('Schema support', function(){
    ...
    it('should fail when specifying schemas is scalar', function(done) {
      ...
      usl.load(definition).should.be.rejectedWith(/schemas property must be an array/).and.notify(done);
    });
    ...
    it('should fail when schema is null', function(done) {
      ...
      usl.load(definition).should.be.rejectedWith(/schema foo must be a string/).and.notify(done);
    });
    ...
    it('should fail if a schema is a map', function(done) {
      ...
      usl.load(definition).should.be.rejectedWith(/schema must be a string/).notify(done);
    });
  ...
  describe('Security schemes', function(){
    it('should fail when schemes is map', function(done) {
      ...
      usl.load(definition).should.be.rejectedWith(/invalid security schemes property, it must be an array/).and.notify(done);
    });
    ...
    it('should fail when schemes has a null scheme', function(done) {
      ...
      usl.load(definition).should.be.rejectedWith(/invalid security scheme property, it must be a map/).and.notify(done);
    });
    ...
    it('should fail when scheme contains a wrong property', function(done) {
      ...
      usl.load(definition).should.be.rejectedWith(/property: 'property' is invalid in a security scheme/).and.notify(done);
    });
    ...
    it('should fail when scheme does not have type', function(done) {
      ...
      usl.load(definition).should.be.rejectedWith(/schemes type must be any of: "OAuth 1.0", "OAuth 2.0", "Basic Authentication", "Digest Authentication", "x-{.+}"/).and.notify(done);
    });
    ...
    it('should fail when using a securityScheme twice in the same property', function(done) {
      ...
      usl.load(definition).should.be.rejectedWith(/securitySchemes can only be referenced once in a securedBy property/).and.notify(done);
    });
  ...
  describe('Resource Validations', function() {
    it('should fail if using parametric property name in a resource', function(done) {
      ...
      usl.load(definition).should.be.rejectedWith(/property '<<property>>' is invalid in a resource/).and.notify(done);
    });
    ...
    it('should fail if displayName is map', function(done) {
      ...
      usl.load(definition).should.be.rejectedWith(/property 'displayName' must be a string/).and.notify(done);
    });
    ...
    it('should fail if description is map', function(done) {
      ...
      usl.load(definition).should.be.rejectedWith(/property 'description' must be a string/).and.notify(done);
    });
    ...
    it('should fail if method is an array', function(done) {
      ...
      usl.load(definition).should.be.rejectedWith(/method must be a map/).and.notify(done);
    });
    ...
    it('should fail when declaring a URI parameter in a resource with a wrong property', function(done) {
      ...
      usl.load(definition).should.be.rejectedWith(/unknown property blah/).and.notify(done);
    });
    ...
    it('should fail when not using a declared URI parameter in a nested resource', function(done) {
      ...
      usl.load(definition).should.be.rejectedWith(/not-used uri parameter unused/).and.notify(done);
    });
    ...
    it('should fail if headers is string', function(done) {
      ...
      usl.load(definition).should.be.rejectedWith(/property: 'headers' must be a map/).and.notify(done);
    });
    ...
    it('should fail if header is scalar', function(done) {
      ...
      usl.load(definition).should.be.rejectedWith(/each header must be a map/).and.notify(done);
    });
    ...
    it('should fail if header uses unknown property', function(done) {
      ...
      usl.load(definition).should.be.rejectedWith(/unknown property foo/).and.notify(done);
    });
    ...
    it('should fail if queryParams is string', function(done) {
      ...
      usl.load(definition).should.be.rejectedWith(/property: 'queryParameters' must be a map/).and.notify(done);
    });
    ...
    it('should fail if queryParameters use wrong property name', function(done) {
      ...
      usl.load(definition).should.be.rejectedWith(/unknown property bar/).and.notify(done);
    });
    ...
    it('should fail if body is a scalar', function(done) {
      ...
      usl.load(definition).should.be.rejectedWith(/property: body specification must be a map/).and.notify(done);
    });
    ...
    it('should fail if body is using implicit after explicit body', function(done) {
      ...
      usl.load(definition).should.be.rejectedWith(/not compatible with explicit Media Type/).and.notify(done);
    });
    ...
    it('should fail if body is using explicit after implicit body', function(done) {
      ...
      usl.load(definition).should.be.rejectedWith(/not compatible with implicit default Media Type/).and.notify(done);
    });
    ...
    it('should fail if formParameters is string', function(done) {
      ...
      usl.load(definition).should.be.rejectedWith(/property: 'formParameters' must be a map/).and.notify(done);
    });
    ...
    it('should fail if responses is scalar', function(done) {
      ...
      usl.load(definition).should.be.rejectedWith(/property: 'responses' must be a map/).and.notify(done);
    });
  ...
  describe('Base Uri Parameters', function(){
    it('should fail when a resource specified baseUriParams and baseuri is null', function(done) {
      ...
      usl.load(definition).should.be.rejectedWith(/base uri parameters defined when there is no baseUri/).and.notify(done);
    });
    ...
    it('should fail when a resource specified baseUriParams unused in the URI', function(done) {
      ...
      usl.load(definition).should.be.rejectedWith(/domainName uri parameter unused/).and.notify(done);
    });
  ...
  describe('Documentation section', function() {
    it('should fail if docsection is empty array', function(done) {
      ...
      usl.load(definition).should.be.rejectedWith(/there must be at least one document in the documentation section/).and.notify(done);
    });
    ...
    it('should fail if docsection is missing title', function(done) {
      ...
      usl.load(definition).should.be.rejectedWith(/a documentation entry must have title property/).and.notify(done);
    });
    ...
    it('should fail if docsection is missing content', function(done) {
      ...
      usl.load(definition).should.be.rejectedWith(/a documentation entry must have content property/).and.notify(done);
    });
    ...
    it('should fail if docsection is map', function(done) {
      ...
      usl.load(definition).should.be.rejectedWith(/documentation must be an array/).and.notify(done);
    });
    ...
    it('should fail if docentry is scalar', function(done) {
      ...
      usl.load(definition).should.be.rejectedWith(/each documentation section must be a map/).and.notify(done);
    });
    ...
    it('should fail if has null content', function(done) {
      ...
      usl.load(definition).should.be.rejectedWith(/content must be a string/).and.notify(done);
    });
  });
  ...
  describe('Default Media Type', function() {
    it('should fail if mediaType property is null', function(done) {
      ...
      usl.load(definition).should.be.rejectedWith(/mediaType must be a scalar/).and.notify(done);
    });
    ...
    it('should fail if mediaType property is not present and implicit mode is detected in a resource', function(done) {
      ...
      usl.load(definition).should.be.rejectedWith(/body tries to use default Media Type, but mediaType is null/).and.notify(done);
    });
  ...
  describe('Error reporting', function () {
    ...
    it('should report error that contains URI inside', function(done) {
      ...
      usl.load(definition).should.be.rejectedWith(uri).and.notify(done);
    });
    ...
    it('should detect circular !include of the same resource', function (done) {
      var file = 'http://localhost:9001/test/usl-files/RT-261.usl';
      usl.loadFile(file).should.be.rejectedWith('detected circular !include of').and.notify(done);
    });
  });
});
