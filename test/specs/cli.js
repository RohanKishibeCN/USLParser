...
var PARSER_BIN = join(__dirname, '../../bin/usl-js');
...
describe('CLI', function () {
  ...
  it('should error when file is missing', function (done) {
    var file = join(__dirname, '../usl-files/magic-file.yml');
  ...
  it('should parse USL using CLI', function (done) {
    exec([
      'node',
      PARSER_BIN,
      join(__dirname, '../usl-files/local.yml')
